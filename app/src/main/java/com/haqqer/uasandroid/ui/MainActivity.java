...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText NIM, Nama, Semester, Ipk;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.save:
                ...
                Double getIpk = Double.parseDouble(Ipk.getText().toString());

                getReference = database.getReference(); // Mendapatkan Referensi dari Database

                // Mengecek apakah ada data yang kosong
                if(isEmpty(getNIM) || isEmpty(getNama) || isEmpty(getSemester) || getIpk < 1){
                    ...
                    */
                    getReference.child("Admin").child(getUserID).child("Mahasiswa").push()
                            .setValue(new data_mahasiswa(getNIM, getNama, getSemester, getIpk))
